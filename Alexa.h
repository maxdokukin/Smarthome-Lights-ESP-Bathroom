...
void setupAlexa() {
  espalexa.addDevice("Bathroom Lights", dl, EspalexaDeviceType::color); // Color device
  espalexa.addDevice("Bathroom Lights Fade", dlf, EspalexaDeviceType::onoff); // Non-dimmable device
